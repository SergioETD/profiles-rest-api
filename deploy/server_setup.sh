...
#Es una serie de comandos que se ejecutan en el servidor  para "bajar" el proyecto
#e instalar todos los requerimientos
...
PROJECT_GIT_URL='https://github.com/SergioETD/profiles-rest-api.git'
